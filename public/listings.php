...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($propertyType == "all") {
    $sql = "SELECT ADDRESS_POSTCODE, ADDRESS_CITY, ADDRESS_STATE, ADDRESS_STREET, PROPERTY_TYPE_NAME, ADVERTISEMENT_PRICE, NUMBER_OF_BEDROOMS, NUMBER_OF_BATHROOMS, SQR_FEET, ADDRESS_NUMBER, ADDRESS_STREET, ADDRESS_CITY, ADDRESS_STATE
